...
def city_name():
    api_request = requests.get("https://api.openweathermap.org/data/2.5/weather?q=mumbai&appid=21cab08deb7b27f4c2b55f3e2df28ea4" + city_entry.get() +"&appid="  +"21cab08deb7b27f4c2b55f3e2df28ea4") 
